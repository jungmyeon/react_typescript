...
// createSlice 에는 name, initialState, reducers 만들어 줘야함
const countSlice = createSlice({    // name, initialState, reducers
  ...
  reducers:{ 
    ...
    {
      state.count += action.payload   // .payloaad 붙여서 사용하기 
    },
    초기화(state){
      state.count = 0
    }
...
// 제공할 리듀서 변수, 할수, State 를 import 할 수 있게 export 
...
// 리듀서 만들기 ( 전역 상채/변수를 수정할 수 있게 제공하는 함수 생성)
